...
func (c *pigeonServiceClient) ProcessTranscriptSummary(ctx context.Context, in *TranscriptSummaryRequest, opts ...grpc.CallOption) (*PigeonTranscriptResponse, error) {
	...
	err := c.cc.Invoke(ctx, PigeonService_ProcessTranscriptSummary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPigeonServiceServer must be embedded to have
...
func (UnimplementedPigeonServiceServer) testEmbeddedByValue()                       {}
...
func RegisterPigeonServiceServer(s grpc.ServiceRegistrar, srv PigeonServiceServer) {
	// If the following call pancis, it indicates UnimplementedPigeonServiceServer was
...
func (c *owlServiceClient) ProcessWriteRequest(ctx context.Context, in *DbWriteRequest, opts ...grpc.CallOption) (*DbWriteResponse, error) {
	...
	err := c.cc.Invoke(ctx, OwlService_ProcessWriteRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedOwlServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedOwlServiceServer) testEmbeddedByValue()                    {}
...
func RegisterOwlServiceServer(s grpc.ServiceRegistrar, srv OwlServiceServer) {
	// If the following call pancis, it indicates UnimplementedOwlServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
